Shader "Aurora/AuroraSky"
{
    Properties
    {
        ...
        _AuroraNoiseStep("Aurora Noise Step", Range(0,10)) = 1
    ...
    float SurAuroraNoise(float2 pos)
    {
        ...
        float2 bp = pos;
    	for (int i=0; i<_AuroraNoiseStep; i++)
    	{
